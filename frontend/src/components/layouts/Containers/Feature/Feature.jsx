...
export default function Feature({children, ...props}) {
  return (
    <div {...props} style={{backgroundColor: props.background}} className={`w-full px-48 flex items-center justify-between my-48 mx-auto ${props.direction}`}>
      <div className="w-1/2">
        ...
        <p className='text-gray text-md font-light'>{props.text}</p>
