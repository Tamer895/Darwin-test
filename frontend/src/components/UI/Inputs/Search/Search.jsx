...
export default function Search(props) {
  ...
  return (
    <form onSubmit={AlgoliaSearch} className='flex-center-between thin-border h-11 px-1 rounded-full'>
      <input value={query} onChange={(e) => setQuery(e.target.value)} className='w-96 focus:w-[450px] duration-100 ease-linear pl-3 flex-1 outline-none text-sm' placeholder={props.placeholder} type="search" />
